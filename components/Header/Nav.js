        ...
        <nav className={styles.navTransparent + " navbar-expand-lg py-2"}>
          <div className="container">
            <div className="row">
              ...
              <MobileNav subMenu={subMenu} activeMenu={activeMenu} selectedCampus={selectedCampus} />
            </div>
          </div>
        </nav>
            ...
            <div className="container">
              <div className="row w-100">
                ...
                <div className="col-lg-9">
                  <div
                    className=" h-100 collapse navbar-collapse desktop-menu justify-content-between"
                    id=""
                  >
                    {subMenu && renderMenu(activeMenu)}
