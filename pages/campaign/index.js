                    ...
                    <div className='container'>
                        ...
                        <div className='row py-5 align-items-center text-center'>
                            <div className='col-lg-12'>
                                <h2 className={style.fw700 + ' ' + style.startText}>Start your Child&apos;s Journey Towards
                    ...
                    <div className='container'>
                        <div className='row'>
                            <div className='col-md-12 col-lg-5'>
                                ...
                                <h4>Email:</h4>
                                <p><Link href='mailto:info@vikasmantra.org'><a>info@vikasmantra.org</a></Link></p>
                                <p><Link href='mailto:admissions@vikasmantra.org'><a>admissions@vikasmantra.org</a></Link></p>
