            ...
            <section className='pt-4'>
                ...
                <div className='container position-relative'>
                    ...
                    <div className='row py-5'>
                        ...
                        <h2 className={styles.headingPdng + '  AnimeStarts' } >Facilities and <br /> Infrastructure</h2>
                ...
                <div className="container">
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-6 position-relative'>
                            ...
                            <h3 className='ulineRed AnimeStarts'>VIKAS MANTRA PUBLIC SCHOOL
                            ...
                            <p className='pt-5 AnimeStarts'>The VIKAS MANTRA PUBLIC SCHOOL Campus is spread over
                            ...
                            <p className='py-3 AnimeStarts'>Complementing these 21st century classrooms are a multitude of learning
                            ...
                            <p className='pb-4 AnimeStarts'>Each floor within the VIKAS MANTRA PUBLIC SCHOOL Campus main school building
                        ...
                        <div className='col-md-6 position-relative'>
                            ...
                            <div className='imgBgColor pastelRed bgImageMargin imgUp AnimeStarts2'>

                                <img src='/assets/campus/school-building3.png' alt="image" className={styles.schlBuildingImg + ' AnimeImage'} />
