                  ...
                  <div className='container'>
                    <div className='row'>
                      <div className='col-md-6'>
                        ...
                        <p className='pt-4'>
                          Oct 8, 2019 marked a historic day in the school&apos;s
                          calendar by launching BE THE CHANGE – an initiative by
                          the school joining hands with BE THE CHANGE to
                          inculcate social responsibilities among children to
                          bring out their innate talents. Chief Guest of the day
                          – Actor and Celebrity Jeeva Ravi.
                        </p>
                      </div>
                  ...
                  <div className='container'>
                    <div className='row'>
                      <div className='col-md-6'>
                        ...
                        <p className='pt-4'>
                          We are happy to announce that our school Vikas Mantra
                          Public school received the Indian icon of the year
                          awards for Best Emerging School ( Holistic) of the
                          year 2021 😀
                        </p>
                      </div>
                    ...
                    <div className='row'>
                      <div className='col-md-6'>
                        <h2 className='ulineRed'>
                          Children&apos;s Day at Raj Nivas
                        </h2>

                        <p className='pt-4'>
                          On the eve of Childrens Day as a part of our Be The
                          Change initiative the students of Vikas Mantra Public
                          School were invited to Raj Nivas Puducherry to meet
                          Lieutenant governor Dr Kiran Bedi. She encouraged the
                          children and interacted with them. Indeed a memorable
                          day in the life of students of VMPS.
                        </p>
                      </div>
