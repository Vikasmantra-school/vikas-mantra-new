                  ...
                  <div className='col-lg-4 col-md-4 col-sm-12'>
                    <div className='card-wrapper one'>
                      <div className='card-header'>
                        ...
                        <p className='card-header-text3'>
                          There will be diagnostic test in Math & Science and
                          Test of fluency in English for students applying from
                          Grade I upwards*. After this Personal interviews
                          conducted with prospective students and parents to
                          understand the child&apos;s interests, skills,
                          abilities, and expectations. Interactions will be held
                          with both parents and the child for the Kindergarten
                          classes.
                        </p>
                      </div>
                      <div className='card-footer'>
