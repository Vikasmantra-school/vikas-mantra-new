...
const Admissions = () => {
  ...
  useEffect(() => {
    ...
    const activateTabFromHash = () => {
      ...
      const targetTabBtn = document.querySelector(`[data-bs-target='${hash}']`);
      if (targetTabBtn) {
        const tab = new bootstrapModule.Tab(targetTabBtn);
        tab.show();
      }
    };

    // Import Bootstrap dynamically (ensures window.bootstrap exists)
    import("bootstrap/dist/js/bootstrap.bundle.min.js").then((bootstrap) => {
      bootstrapModule = bootstrap;
      activateTabFromHash();
    });

    // When route or hash changes in Next.js
        ...
        <div className="container position-relative">
          <div className="row py-5">
            <div className="AdmissionAnimeStarts AnimeStarts">
              <h2
                className={
                  styles.headingPdng + " AdmissionAnimeElement AnimeElement "
                }>
                Admissions
              </h2>
            </div>
                    ...
                    <div className="card-body ">
                      ...
                      <div className="AdmissionAnimeStarts AnimeStarts">
                        <h6 className="card-text pt-5 AdmissionScrollAnimeElement AnimeElement">
                          ...
                          student and provide a platform to maximize each
                    ...
                    <div className="card-body">
                      ...
                      <ul className="pt-5 list-points AdmissionAnimeStarts">
                        <li className="pt-1 AdmissionScrollAnimeElement">
                          ...
                          must fall into 3 years age category as prescribed and
                          suggested by the central board of secondary education.
                        </li>
                        <li className="pt-1 AdmissionScrollAnimeElement">
                          <img
                            src="/assets/icons/pink-point.png"
                            alt="list-point"
                          />
                          For Junior KG the child must have completed 4 years as
                          on 30th March.
                        </li>
                        <li className="pt-1 AdmissionScrollAnimeElement">
                          <img
                            ...
                            alt="list-point"
                          />
                          For Senior KG the child must have completed 5 years as
                          on 30th March.
                        </li>
                        <li className="pt-1 AdmissionScrollAnimeElement">
                          <img
                            ...
                            alt="list-point"
                          />
                          For 1st Grade the child must have completed 6 years as
                          on 30th March.
                        </li>
                      </ul>
                    </div>
