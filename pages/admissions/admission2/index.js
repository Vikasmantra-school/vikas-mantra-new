    ...
    const data = [
        {
            id: "1",
            key: "1",
            img: "/assets/banners/school-building2.png"
        },
        {
            id: "2",
            key: "2",
    ...
    const btnData = [
        {
            ...
            key: "1",
            img: "/assets/banners/school-building2.png",
            buttonName: 'Admission Overview',
            btnClass: 'active',
            btnId: 'v-pills-home-tab',
            btnTarget: '#v-pills-home-tab',
            btnControls: 'v-pills-home-tab',
            btnSelected: 'true',
        },
        {
            id: "2",
            key: "2",
            img: "/assets/banners/school-building2.png",
            buttonName: 'Admission Timeline',
            btnClass: 'null',
            btnId: 'v-pills-profile-tab',
            btnTarget: '#v-pills-profile-tab',
            btnControls: 'v-pills-profile-tab',
            btnSelected: 'false',
        },
        {
            id: "3",
            key: "3",
            img: "/assets/banners/school-building2.png",
            buttonName: 'Admission Procedure',
            btnClass: 'null',
            btnId: 'v-pills-messages-tab',
            btnTarget: '#v-pills-messages-tab',
            btnControls: 'v-pills-messages-tab',
            btnSelected: 'false',
        },
        {
            id: "4",
            ...
            buttonName: 'FAQ',
            btnClass: 'null',
            btnId: 'v-pills-settings-tab',
            btnTarget: '#v-pills-settings-tab',
            btnControls: 'v-pills-settings-tab',
            btnSelected: 'false',
        }
    ];
            ...
            <section className={styles.sectionPdng + ' greybg'}>
                ...
                <div className='container'>
                            ...
                            <div className='row align-items-start'>
                                ...
                                <div className=' col-md-4'>
                                    ...
                                    <div className={styles.tabWidth + ' nav flex-column nav-pills me-3'} id='v-pills-tab' role='tablist'
                                        ...
                                        {/* <button
                                    className={styles.tabBtn + ' ' + styles.redBorder
                                ...
                                <button
                                    className={styles.tabBtn + ' ' + ' nav-link text-start color-black position-relative'}
                                ...
                                >
                                    ...
                                    <FontAwesomeIcon icon={faCaretLeft} className={styles.leftIcon} />
                                        ...
                                        <button
                                            ...
                                            type='button'
                                            role='tab'
                                            aria-controls={btnControls}
                                            aria-selected={btnSelected}
                                            onClick={() => setToggle(i)}
                                        >
                                ...
                                <div className='col-md-8'>
                                    ...
                                    <div className="img">
                                        {toggle === key ? (
                                            <>
                                                <img src={img} key={key} className={styles.schoolBuildingImg} />
                                            </>
                                        ) : null}
                                    </div>
                    ...
                    <div className={'tab-content ' + styles.tab3VectorStarGreen} id=' v-pills-tabContent'>
                        ...
                        <div className={' tab-pane fade show active VectorSpiralBlue dot-vector-after ' + styles.Tab1BlueVector + ' ' +
                            styles.tab1RedDotVector} id='v-pills-home' role='tabpanel' aria-labelledby='v-pills-home-tab' tabIndex='0'>
