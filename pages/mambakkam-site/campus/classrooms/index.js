        ...
        <div className='container position-relative'>
          <div className='row py-5'>
            ...
            <div className='AnimeStarts'>
              <h2 className={styles.headingPdng + ' AnimeElement'}>Classrooms</h2>
            </div>
        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className={'col-lg-6 col-md-12 position-relative ' + styles.vmpsImg}>
              ...
              <div className={styles.classroomImgDiv + ' imgBgColor imgUp pastelPurple AnimeStarts'}>
                ...
                <img
                  src='/assets/campus/classroom-new.jpeg'
                  alt='image'
          ...
          <div className='row py-5'>
            <div className='col-md-12'>
              ...
              <div className='AnimeStarts'>
                <h3 className={'ulineRed AnimeElement ' + styles.ulineMargin}>About our classrooms</h3>
              </div>
            ...
            <div className={styles.pdngZero + ' col-md-3 pt-5 pb-4 '}>
              <ul className='list-points AnimeStarts'>
                <li className='AnimeElement'> <img src="/assets/icons/blue-point.png" alt='list-point' /> Large (575 sq ft), well-ventilated and naturally-lit</li>
              </ul>
            </div>
            ...
            <div className={styles.pdngZero + ' col-md-3 pt-5 pb-4 '}>
              <ul className='list-points AnimeStarts'>
                <li className='AnimeElement'><img src="/assets/icons/yellow-point.png" alt='list-point' />Student safe furniture</li>
              </ul>
            </div>

            <div className={styles.pdngZero + ' col-md-3 pt-5 pb-4 '}>
              <ul className='list-points AnimeStarts'>
                <li className='AnimeElement'><img src="/assets/icons/lightgreen-point.png" alt='list-point' />Storage space for every student</li>
              </ul>
            </div>
            ...
            <div className='col-md-3'>
              <ul className='list-points AnimeStarts'>
                <li className='AnimeElement'><img src="/assets/icons/darkblue-point.png" alt='list-point' />Wi-Fi-enabled</li>
              </ul>
            </div>

            <div className='col-md-3'>
              <ul className='list-points AnimeStarts'>
                <li className='AnimeElement'><img src="/assets/icons/red-point.png" alt='list-point' />Interactive boards</li>
              </ul>
            </div>

            <div className='col-md-3'>
              <ul className='list-points AnimeStarts'>
                <li className='AnimeElement'><img src="/assets/icons/lightblue.png" alt='list-point' />Reading corners to promote the habit of reading</li>
              </ul>
            </div>

            <div className='col-md-3'>
              <ul className='list-points AnimeStarts'>
                <li className='AnimeElement'><img src="/assets/icons/green-point.png" alt='list-point' />
