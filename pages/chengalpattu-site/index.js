...
function Home() {
  ...
  return (
    <>
                ...
                <SplideSlide>
                  <div className="row align-items-center bottomToTop">
                    <div className="col-xl-4 col-lg-5 col-md-12 col-sm-12">
                      ...
                      <p className="pt-4">
                        At Vikas Mantra Public School, we believe in making
                        every child grow up to become the best version of
                        themselves. State-of-the-art infrastructure, a vibrantly
                        positive environment, experienced teaching faculty, and
                        a multitude of activities and programs, are just a few
                        of what we provide for the sole purpose of enabling
                        children to develop into self-aware, socially
                        responsible, intellectually advanced and strongly
      ...
      <section
        className={styles.SchoolVideoSection + " whitebg parentAnimeStarts "}>
        <div
