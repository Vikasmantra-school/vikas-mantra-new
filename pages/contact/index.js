...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section
        className={
          " whitebg pb60 position-relative " + " " + styles.vectorImg10
        }>
        <div className="container">
          <div className={styles.rowPdng + " row text-center"}>
            <div className={"col-md-4 " + " " + styles.mobColPdng}>
              <div className="ContactAnimeStarts">
                <img
                  ...
                  alt="image"
                  className={styles.iconsImg + " AnimeElement1"}
                />
              </div>
              ...
              <div className={styles.paraAlign}>
                ...
                {/* 
                <div className="ContactAnimeStarts">
                  <p className="m-0 AnimeElement1">S.No:oonta168,168/3,</p>
                </div>

                <div className="ContactAnimeStarts">
                  <p className="m-0 AnimeElement1">Off Mahindra World City,</p>
                </div>
                ...
                <div className="ContactAnimeStarts">
                  <p className="m-0 AnimeElement1">
                    Vandalur to Kelambakkam Road,
                  </p>
                </div>

                <div className="ContactAnimeStarts">
                  <p className="m-0 AnimeElement1">Mambakkam, Chennai,</p>
                </div>
            ...
            <div className={"col-md-4 " + " " + styles.mobColPdng}>
              <div className="ContactAnimeStarts2">
                <img
                  ...
                  alt="image"
                  className={styles.iconsImg + " AnimeElement2"}
                />
              </div>
            ...
            <div
              className={
                "col-md-4 position-relative " + " " + styles.mobColPdng
              }>
              <div className="ContactAnimeStarts3">
                <img
                  src="/assets/icons/time.png"
                  alt="image"
                  className={styles.iconsImg + " AnimeElement3"}
                />
              </div>
