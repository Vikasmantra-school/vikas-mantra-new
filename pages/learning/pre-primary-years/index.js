          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="mb-5 learningDivs" id="programs">
                ...
                <div className="AnimeStarts">
                  <p className="pt-4 AnimeElement">
                    Happy Tots offers a well-structured curriculum from
                    Kindergarten to Pre-primary. The program engages children in
                    exciting learning activities specifically designed to meet
                    the developmental needs and help them advance to the next
                    level. The curriculum emphasizes language and literacy,
                    cognitive development, social-emotional skills, physical
            ...
            <div className="col-md-6">
              ...
              <div
                className={"sticky-sidebar VectorSpiralBlue" + "  " + "pt60"}>
                <ul id="progress">
